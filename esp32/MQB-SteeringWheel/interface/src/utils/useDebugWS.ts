...
//import {WebSocketMessage} from "./useWs"
...
type WebSocketMessage<D> = WebSocketIdMessage | WebSocketPayloadMessage<D>;

export const useDebugWS = <D>(wsUrl: string, wsThrottle: number = 100) => {
            ...
            switch (message.type) {
                ...
                case "payload":
                    ...
                    if (clientId.current) {
                        ...
                        //let data2 = ((clientId.current === message.origin_id && existingData) || message.payload)
                        let data2 = message.payload;
